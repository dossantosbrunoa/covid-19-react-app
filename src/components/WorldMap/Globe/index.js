...
const Globe = ({ 
  ...
  onMouseLeave
    ...
    const getCovidData = (geo) => {
        const summaryListElement = summaryList.find(c => c.alpha2Code === geo.properties.ISO_A2);
        return {
            value: summaryListElement ? numberPerHabitants*summaryListElement[dataType]/summaryListElement.population : 0,
